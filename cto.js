...
function renderTrialsView(container, trials, companyName) {
    ...
    container.innerHTML = `
      <div class="p-6">
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
          <p class="text-gray-700 dark:text-gray-300">No clinical trials found for this company. Please try another search.</p>
        </div>
      </div>
    `;
    return;
  ...
  const headerContent = `
    <div class="p-6 border-b border-gray-200 dark:border-gray-700">
      ...
      <div class="mb-4">
        <input type="text" id="search-input" class="w-full px-4 py-2 bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 border border-gray-300 dark:border-gray-700 rounded" 
               placeholder="Search by title, ID, location...">
      </div>
    </div>
  `;
